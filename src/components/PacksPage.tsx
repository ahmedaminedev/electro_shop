...
export const PacksPage: React.FC<PacksPageProps> = ({ onNavigateHome, onNavigateToCategory, isNavCollapsed, onToggleNav, packs, allProducts, allPacks, categories, onNavigateToPacks, onNavigateToPackDetail }) => {
